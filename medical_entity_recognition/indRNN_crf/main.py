...
import time
import random
from medical_entity_recognition.indRNN_crf.model import BiLSTM_CRF
from medical_entity_recognition.indRNN_crf.utils import str2bool, get_logger, get_entity_keys
from medical_entity_recognition.indRNN_crf.data import read_corpus, read_dictionary, tag2label, random_embedding
...
parser.add_argument('--hidden_dim',type=int, default=300, help='#dim of hidden state') #300
...
parser.add_argument('--demo_model', type=str, default='random_indrnn_crf', help='model for test and demo')#random_char_300,1524919794
